    ...
    <div className="flex justify-center bg-white">
      <div className="w-full">
        <div className="relative flex w-full flex-wrap items-stretch">
          ...
          />
          <button
            className="relative z-[2] flex items-center rounded-r bg-black px-6 py-2.5 text-xs font-medium uppercase leading-tight text-black shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
            type="button"
            id="button-addon1"
            data-te-ripple-init
